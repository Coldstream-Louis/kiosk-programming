...
Vue.component('ingredient', {
    ...
    template: ' <div class="ingredient">\
                  <label>\
                    ...
                    {{item["ingredient_en"]}} ({{ (type=="smoothie") ? item.vol_smoothie:item.vol_juice }} ml), {{item.selling_price}}:-, {{item.stock}} pcs  <img v-bind:src=getImgPath(item) :width="100" :height="100"></img>\
                  </label>\
              </div>',
    methods: {
